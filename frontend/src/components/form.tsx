...
export default function Form({ contentForm }: formProps) {
  const { value,handleChange, cleanForm,sendForm } = useValue(contentForm);
  return (
    <div>
    <form>
      <FieldGroup>
                      ...
                      return (
                        ...
                        >
                          ...
                          <Input
                            ...
                            value={value[section.sectionTitle]?.[field.fieldTitle] as string ?? ""}
                            ...
                            return (
                              ...
                              >
                                <Checkbox
                                  ...
                                  checked={value[section.sectionTitle]?.[field.fieldTitle].includes(option.optionName) ?? false}
